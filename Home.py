...
show_pages(
    [   
        ...
        Page("pages/09_Equities_News_v1.py", "Equities News v1", icon="📰", in_section=False),
        Page("pages/10_Equities_News_v2.py", "Equities News v2", icon="📰", in_section=False),
        Page("pages/15_Google_Trends.py", "Google Trends", icon="📉", in_section=False),
